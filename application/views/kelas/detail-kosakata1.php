...
<script>
    ...
    $("#btnInputNilai").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url()?>kosakata1/get_nilai",
            dataType: "JSON",
    ...
    $("#dataPeserta").on("click", "#btnSimpanNilai", function(){
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?= base_url()?>kosakata1/input_nilai",
                    dataType: "JSON",
    ...
    // onchange pertemuan 
        $("#dataPertemuan").on('change', '#rekapPertemuan', function(){    
            ...
            if(value != ""){
                ...
                $.ajax({
                    type : "POST",
                    url : "<?= base_url()?>kosakata1/ajax_pertemuan",
                    dataType : "JSON",
    ...
    // function
                    ...
                    html += `<div class="col-12 col-md-4 mb-2">
                                <ul class="list-group shadow">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <span>
                                            <a target="_blank" href="<?= base_url()?>kosakata1/rekap_nilai/`+data.kelas.link+`" class="btn btn-md btn-success"><i class="fa fa-download"></i></a>
                                        </span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between">
                                        <span>
        ...
        function detail_peserta(id){
            $.ajax({
                url : "<?=base_url()?>kosakata1/get_detail_peserta",
                method : "POST",
