                    ...
                    <div class="card-body cus-font">
                        ...
                        <form id="formFaq">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn btn-md btn-primary" id="btnAddFaq">Tambah FAQ</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <div class="card-body cus-font">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn btn-md btn-danger mr-1" id="btnDeleteFaq">Delete</button>
                            <button type="button" class="btn btn-md btn-success" id="btnEditFaq">Ubah</button>
                        </div>
                    </div>
                </div>
            </div>
